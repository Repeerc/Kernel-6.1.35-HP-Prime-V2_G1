...
#define VIDCON0_VIDOUT_MASK			(0x7 << 22)
#define VIDCON0_VIDOUT_SHIFT			22
#define VIDCON0_VIDOUT_RGB			(0x0 << 22)
#define VIDCON0_VIDOUT_TV			(0x1 << 22)
#define VIDCON0_VIDOUT_I80_LDI0			(0x2 << 22)
#define VIDCON0_VIDOUT_I80_LDI1			(0x3 << 22)
#define VIDCON0_VIDOUT_WB_RGB			(0x4 << 22)
#define VIDCON0_VIDOUT_WB_I80_LDI0		(0x6 << 22)
#define VIDCON0_VIDOUT_WB_I80_LDI1		(0x7 << 22)

#define VIDCON0_L1_DATA_MASK			(0x7 << 19)
#define VIDCON0_L1_DATA_SHIFT			19
#define VIDCON0_L1_DATA_16BPP			(0x0 << 19)
#define VIDCON0_L1_DATA_18BPP16			(0x1 << 19)
#define VIDCON0_L1_DATA_18BPP9			(0x2 << 19)
#define VIDCON0_L1_DATA_24BPP			(0x3 << 19)
#define VIDCON0_L1_DATA_18BPP			(0x4 << 19)
#define VIDCON0_L1_DATA_16BPP8			(0x5 << 19)

#define VIDCON0_L0_DATA_MASK			(0x7 << 16)
#define VIDCON0_L0_DATA_SHIFT			16
#define VIDCON0_L0_DATA_16BPP			(0x0 << 16)
#define VIDCON0_L0_DATA_18BPP16			(0x1 << 16)
#define VIDCON0_L0_DATA_18BPP9			(0x2 << 16)
#define VIDCON0_L0_DATA_24BPP			(0x3 << 16)
#define VIDCON0_L0_DATA_18BPP			(0x4 << 16)
#define VIDCON0_L0_DATA_16BPP8			(0x5 << 16)

#define VIDCON0_PNRMODE_MASK			(0x3 << 13)
#define VIDCON0_PNRMODE_SHIFT			13
#define VIDCON0_PNRMODE_RGB			(0x0 << 13)
#define VIDCON0_PNRMODE_BGR			(0x1 << 13)
#define VIDCON0_PNRMODE_SERIAL_RGB		(0x2 << 13)
